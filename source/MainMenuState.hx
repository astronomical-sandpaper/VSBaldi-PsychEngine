...
class MainMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var bg:FlxSprite = new FlxSprite(-80).loadGraphic(Paths.image('da schoolhouse/menu/menuBG', 'shared'));
		bg.scrollFactor.x = 0;
		bg.scrollFactor.y = 0;
		...
		magenta = new FlxSprite(-80).loadGraphic(Paths.image('da schoolhouse/menu/menuDesat', 'shared'));
		...
		var versionShit:FlxText = new FlxText(5, FlxG.height - 18, 0, "Psych Engine v" + psychEngineVersion, 12);
